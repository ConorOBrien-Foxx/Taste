			...
			if (_v0.b.b) {
				if (!_v0.b.b.b) {
					...
					if ((((_v0.a.$ === 'Multiply') && (_v0.b.a.$ === 'TasteNumeric')) && (_v0.b.b.a.$ === 'TasteFunction')) && (!_v0.b.b.b.b)) {
						...
						var _v6 = _v4.b;
						var _v7 = _v6.a;
						return $author$project$Types$TasteList;
					} else {
						break _v0$2;
					}
				}
...
var $author$project$Decode$decodeStep = function (state) {
	...
	while (true) {
		...
		var augmented = function () {
			var _v4 = A2($author$project$Util$debug, 'leaf', leaf);
			switch (_v4.$) {
				case 'TypeLeaf':
					return state;
				case 'OpLeaf':
...
var $author$project$Evaluate$defaultState = function (input) {
	return {
		...
		z: $author$project$Atom$TypeInteger(16)
	};
};
			...
			switch (op.$) {
				...
				case 'DataLeaf':
					switch (op.a.$) {
						...
						case 'Input':
							var _v18 = op.a;
							var _v19 = $author$project$Evaluate$popType(state);
							var tasteType = _v19.a;
							var nextState = _v19.b;
							var finalType = A2($elm$core$Maybe$withDefault, $author$project$Types$TasteNumeric, tasteType);
							var _v20 = A2($author$project$Evaluate$parseInput, finalType, nextState.input);
							var element = _v20.a;
							var nextInput = _v20.b;
							return _Utils_update(
								nextState,
								{
									input: nextInput,
														...
														case 'TypeList':
															switch (_v24.a.$) {
																...
																case 'TypeFunction':
																	...
																	var v = _v27.a.a;
																	var rest = _v27.b;
																	var _v28 = A3($author$project$Evaluate$stateMap, fn, state, v);
																	var returnState = _v28.a;
																	var mapped = _v28.b;
																	return _Utils_Tuple2(
																		returnState,
																		_Utils_ap(
							...
							return $author$project$Evaluate$applyStack(
								function () {
									...
									while (true) {
												...
												if (!_v32.b.b) {
													...
													switch (_v32.a.$) {
														case 'Error':
															break _v32$1;
														case 'TypeFunction':
															if (_v32.b.a.$ === 'TypeInteger') {
																var fn = _v32.a.a;
																var _v33 = _v32.b;
																var n = _v33.a.a;
																var rest = _v33.b;
																var _v34 = A3(
																	$author$project$Evaluate$stateMap,
																	fn,
																	state,
																	A2(
																		$elm$core$List$map,
										...
										var rest = _v35.b;
										var value = function () {
											var _v36 = _Utils_Tuple2(first, second);
											_v36$4:
											while (true) {
												switch (_v36.a.$) {
													case 'TypeInteger':
		...
		while (true) {
			if (!ops.b) {
				...
				if ((ops.a.$ === 'DataLeaf') && (ops.a.a.$ === 'Function')) {
					var _v5 = ops.a.a;
					var rest = ops.b;
					var _v6 = $author$project$Evaluate$readFunction(rest);
					var fn = _v6.a;
					var term = _v6.b;
					var next = _v6.c;
					var $temp$ops = next,
...
var $author$project$Evaluate$stateFoldl = F3(
	function (fn, state, seed) {
		return A2(
			$elm$core$List$foldl,
			F2(
				function (el, _v2) {
					var inner = _v2.a;
					var folding = _v2.b;
					var _v3 = A4($author$project$Evaluate$evaluateAt2, fn, inner, folding, el);
					var nextInner = _v3.a;
					var atom = _v3.b;
					return _Utils_Tuple2(nextInner, atom);
				}),
			_Utils_Tuple2(state, seed));
	});
...
var $author$project$Util$flatten = $elm$core$List$concatMap(
	function (x) {
		return x;
	});
										...
										A2(
											...
											$author$project$Decode$decode(
												A2(
													$author$project$Util$debug,
													'Before decode\n',
													A2($elm$core$List$concatMap, $author$project$CodeTree$invertInstruction, x))))))).stack));
				},
				A2(
					$elm$core$Tuple$mapFirst,
					A2(
						$elm$core$Basics$composeR,
						$elm$core$List$map($author$project$CodeTree$invertInstruction),
						function (bits) {
